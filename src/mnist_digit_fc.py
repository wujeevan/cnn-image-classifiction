...
epochs = 120
model_design = Models.mnist_digit_fc
data_name = 'mnist_digit_fc'
dirs = '../data/{}'.format('mnist_digit')
...
checkpoint = ModelCheckpoint(model_save_path, monitor='val_acc', save_best_only=True, verbose=1)
...
model.fit(x_train, y_train, epochs=epochs, batch_size=batch_size,
          validation_data=(x_test, y_test), callbacks=[checkpoint, lrschedual], verbose=2)
